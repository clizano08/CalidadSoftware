...
namespace App_VentaSnacks.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,Precio,Estado")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,Precio,Estado")] Producto producto)
        {
            if (ModelState.IsValid)
            {
